...
if(iscop)then{
	...
	_stock = ["Apples", (shop1 call INV_getshopnum)] call INV_getstock;
	_stock = _stock + (["Apples", (shop2 call INV_getshopnum)] call INV_getstock);
	_stock = _stock + (["Apples", (shop3 call INV_getshopnum)] call INV_getstock);
	_stock = _stock + (["Apples", (shop4 call INV_getshopnum)] call INV_getstock);

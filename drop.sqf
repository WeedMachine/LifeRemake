...
da = "THIS PLAYER ATTEMPTED TO DROP " + format ["%1", _amount ] + ". NickName = " + (name player);

if(_amount <= 0)then {server globalChat "!!WARNING!! !!CHEATER!! KICK THIS PLAYER OR BAN", server GlobalChat da } else {

...
if(_vcl iskindof "ship" and (_item == "supgrade2" or _item == "supgrade3" or _item == "supgrade4" or _item == "supgrade5"))exitwith{player groupchat "you can only tune boats with speed upgrade 1!"};

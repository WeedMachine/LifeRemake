...
if(player distance playerhood < 48) then
{
...
player addaction ["Home storage (saved)","storage.sqf",["private_storage", "save"],1,false,true,"","player distance hideoutbox%1%2 < 6"];
